...
public class ASCIIBoard {
    public static List<String> formatBoardAsLines(List<Integer> storeSeeds, List<List<Integer>> houseSeedsList) {
    ...
    private static String formatLine1(List<Integer> storeSeeds, List<List<Integer>> houseSeedsList) {
        String asciiLine;
    ...
    private static String formatLine2(List<Integer> storeSeeds, List<List<Integer>> houseSeedsList) {
        String asciiLine;
        List<Integer> houseSeeds;
        int playerI = 0;
    ...
    private static int nextPlayerIndex(int playerI) {
